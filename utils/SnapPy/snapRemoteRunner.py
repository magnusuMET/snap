...
Structure below directory is:
     ...
     autotestruns/ : files used for end-to-end testing
...
class SnapTask:
    ...
    def _handle(self, hpc):
        if self.zipfile.endswith("-auto-test-run_SNAP2ARGOS.zip"):
            top_rundir = os.path.join(self.topdir, SnapRemoteRunner.TEST_DIR)
        else:
